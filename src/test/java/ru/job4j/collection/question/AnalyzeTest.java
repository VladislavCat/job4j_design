...
public class AnalyzeTest {
    ...
    @Test
    public void whenMultiAllChanged() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set<User> previous = Set.of(u1, u2, u3);
        Set<User> current = Set.of(new User(1, "All"), new User(12, "AllChanged"), new User(3, "12"),
                new User(4, "User4"), new User(11, "UserOneOne"));
        assertEquals(Analyze.diff(previous, current), new Info(3, 2, 1));
    }
}
